...
export const deleteConversation = mutation({
    ...
    handler: async (ctx, args) => {
        ...
        const user = await ctx.db.query("users").withIndex("by_userId", (q) => q.eq("userId", args.userId))
        .first();
